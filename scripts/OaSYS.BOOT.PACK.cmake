IF(CONFIG_BOOT_PACK)
	...
	SET(EFI_BOOTLOADER ${PROJECT_BINARY_DIR}/boot/${EFI_BOOT_IMAGE_FILENAME})

	ADD_CUSTOM_COMMAND(
		OUTPUT ${EFI_BOOT_IMAGE}
		DEPENDS ${EFI_BOOT_IMAGE_FILENAME}
	...
	ADD_CUSTOM_TARGET(BOOT_IMAGE ALL DEPENDS ${EFI_BOOT_IMAGE})
ENDIF()
